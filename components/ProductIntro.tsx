      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-2xl mb-14">
          ...
          <h2 className="text-3xl font-bold text-slate-900 mb-5 leading-snug tracking-tight">
            {t.productIntro.headline1}
            <br />
            {t.productIntro.headline2}
          </h2>
          <p className="text-slate-500 leading-relaxed mb-4">{t.productIntro.body1}</p>
          <p className="text-slate-500 leading-relaxed mb-6">{t.productIntro.body2}</p>
          <a
            href="#how-it-works"
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-5">
            Tap any card to see the product view
          </p>
          <ProductJourney />
        </div>
      </div>
