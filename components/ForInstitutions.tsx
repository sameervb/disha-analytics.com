const partners = [
  {
    ...
    role: "Referral and grant channel",
    body:
      "Refer restaurant owner members to Disha as a certified AI intelligence tool. Grant eligibility is pre-mapped to existing SMB digitalisation programs.",
  },
  {
  ...
  },
  {
    ...
    role: "Policy and digital transformation",
    body:
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-14">
          ...
          <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
            Disha is designed to plug into existing advisory channels, not compete with them.
            We turn referral relationships into measurable outcomes for your members.
          </p>
        </div>
        ...
        <div className="bg-slate-800/60 border border-slate-700/60 rounded-2xl p-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.ask}>
                <div className="text-sm font-semibold text-white mb-1.5">{item.ask}</div>
